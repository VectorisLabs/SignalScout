...
const collectionTool = {
  ...
  parameters: {
    ...
    properties: {
      ...
      date_from: { type: "string", description: "Inclusive start of the evidence window as a calendar date, format YYYY-MM-DD (e.g. 2021-01-01)." },
      date_to: { type: "string", description: "Inclusive end of the evidence window as a calendar date, format YYYY-MM-DD (e.g. 2023-07-31)." },
      replay_as_of: { type: "string", description: "Replay boundary as a full ISO-8601 datetime with timezone, format YYYY-MM-DDTHH:mm:ss.sssZ (e.g. 2023-07-31T23:59:59.999Z). Must be at or after date_to end-of-day." },
